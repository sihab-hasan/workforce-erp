...
import type { EmploymentStatus } from "#features/employees/types/employees.types.ts";
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        onValueChange={(val) => onFiltersChange({ status: val as EmploymentStatus | "all" })}
      >
        <SelectTrigger id="filter-status" aria-label="Filter by status" className="w-full sm:w-40">
