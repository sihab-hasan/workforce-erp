...
import { EmployeeStatusBadge } from "#features/employees/components/EmployeeStatusBadge.tsx";
import type { Employee } from "#features/employees/types/employees.types.ts";
              ...
              <TableBody>
                {employees.map((emp) => (
                  <TableRow key={emp.id}>
                    ...
                    {/* ── Hire date ── */}
                    <TableCell>
                      <time dateTime={emp.hireDate} className="text-sm text-muted-foreground">
                    ...
                    <TableCell className="pr-6 text-right">
                      <Button
                        ...
                        nativeButton={!tenantKey || !companyKey}
                        render={
                          tenantKey && companyKey ? (
                            <Link
                              to={companyRoutes.employeeDetails(tenantKey, companyKey, emp.id)}
                            />
                          ) : undefined
                        }
                      >
                ...
                <li key={emp.id}>
                  ...
                  <div className="flex items-center gap-3 px-6 py-4">
                    ...
                    <Button
                      ...
                      render={
                        tenantKey && companyKey ? (
                          <Link to={companyRoutes.employeeDetails(tenantKey, companyKey, emp.id)} />
                        ) : undefined
                      }
                    >
                      <ChevronRight className="size-4" aria-hidden />
