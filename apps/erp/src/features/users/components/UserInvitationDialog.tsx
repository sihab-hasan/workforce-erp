...
export function UserInvitationDialog({ open, onOpenChange }: UserInvitationDialogProps) {
    ...
    inviteMutation.mutate(
      {
        ...
        ...(values.employee_id !== undefined ? { employee_id: values.employee_id } : {}),
      },
      {
        onSuccess: (response) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Send an account invitation email with designated role, organization, and optional
