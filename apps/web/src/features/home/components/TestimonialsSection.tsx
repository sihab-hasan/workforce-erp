...
function getTestimonial(index: number) {
...
export function TestimonialsSection({ className }: TestimonialsSectionProps) {
  ...
  const activeTestimonial = getTestimonial(activeIndex);
  const previewIndexes = [getNextIndex(activeIndex, 1), getNextIndex(activeIndex, 2)];
    ...
    >
      <Container>
        <header className="mb-8 max-w-3xl sm:mb-10 lg:mb-12">
          ...
          >
            See how growing teams bring people, time, payroll, and performance into one clear view.
          </p>
        </header>
        ...
        >
          ...
          >
            ...
            <div className="flex min-h-[28rem] flex-col bg-primary p-6 text-primary-foreground sm:p-8 lg:min-h-full lg:p-10 xl:p-12">
              <div key={activeTestimonial.id} aria-live="polite" data-testimonial-copy>
                ...
                <div className="mt-6">
                  <p className="font-heading text-xl font-bold">{activeTestimonial.name}</p>
          ...
          <p className="sr-only">
            Use the previous and next buttons, image previews, or the left and right arrow keys to
            browse testimonials.
          </p>
        </div>
      </Container>
