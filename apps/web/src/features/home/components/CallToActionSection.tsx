...
export function CallToActionSection({ className }: CallToActionSectionProps) {
  ...
  useGSAP(
    () => {
      ...
      const paths = gsap.utils.toArray<SVGPathElement>("[data-cta-path]");
      ...
      <div ref={ctaRef}>
        ...
        <div className="relative grid items-center gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(22rem,0.85fr)] lg:gap-20">
          <div className="max-w-3xl">
            <h2
              data-cta-heading
              className="font-heading text-4xl leading-[1.08] font-bold tracking-[-0.04em] text-balance sm:text-5xl lg:text-6xl"
            >
              Bring your people, payroll, and operations into one clear system.
            </h2>
            <p
              data-cta-copy
              className="mt-6 max-w-2xl text-base leading-7 text-primary-foreground/75 sm:text-lg sm:leading-8"
            >
              See how Workforce ERP can replace scattered workflows with one connected way to run
              your business.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start gap-7">
            ...
            <p
              data-cta-proof
              className="flex items-center gap-3 text-sm leading-6 text-primary-foreground/75 sm:text-base"
            >
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke="currentColor"
      />
      <circle data-cta-node cx="92" cy="109" r="6" fill="currentColor" />
      <circle data-cta-node cx="194" cy="134" r="4" fill="currentColor" />
      <circle data-cta-node cx="330" cy="73" r="7" fill="currentColor" />
      <circle data-cta-node cx="402" cy="163" r="5" fill="currentColor" />
    </svg>
  );
}
