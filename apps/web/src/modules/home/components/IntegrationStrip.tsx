...
export function IntegrationStrip({ className }: IntegrationStripProps) {
  ...
  return (
    <section
      ...
      className={cn(
        "overflow-hidden bg-background py-20 sm:py-24 lg:py-28",
        className
      )}
    >
      <Container>
        <header className="grid items-end gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(22rem,0.65fr)] lg:gap-16">
          ...
          <div className="max-w-xl lg:justify-self-end">
            ...
            >
              Connect Workforce ERP with the platforms your teams use every
              day—without rebuilding the way they work.
            </p>
            <Link
              data-integrations-action
      ...
      >
            ...
            {[0, 1].map((groupIndex) => (
              ...
              >
                <li className="flex h-32 w-44 shrink-0 items-center justify-center rounded-xl bg-primary px-5 text-center text-primary-foreground shadow-lg lg:hidden">
                  <span>
                    <span className="block font-heading text-4xl font-extrabold">
                      W
                    </span>
        ...
        >
          <span>
            <span className="block font-heading text-5xl leading-none font-extrabold">
              W
            </span>
