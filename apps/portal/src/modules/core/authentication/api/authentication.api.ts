import type { AuthSession } from "@workforce-erp/auth-client"
...
export function toAuthSession(response: AuthSuccessResponse): AuthSession {
  return {
    user: {
...
export const authenticationApi = {
  ...
  me: () =>
    apiClient.get<{ success: boolean; user: AuthUserPayload }>(
      "/api/v1/auth/me"
    ),
  sessions: () =>
    apiClient.get<{ success: boolean; data: AuthSessionRecord[] }>(
