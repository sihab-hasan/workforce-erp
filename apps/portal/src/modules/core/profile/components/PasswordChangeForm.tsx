...
import { profileSecurityApi } from "@/modules/core/profile/api/profile.api"
...
export function PasswordChangeForm({ className }: PasswordChangeFormProps) {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      signOut()
      navigate("/auth/login?passwordChanged=success", { replace: true })
    } catch (err) {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground">
        Changing your password signs out every active API session, including
        this one.
      </p>
    </form>
  )
