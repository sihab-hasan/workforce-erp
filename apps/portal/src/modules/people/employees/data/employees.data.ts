...
/**
 * Mock employee dataset — frontend-only placeholder.
 * Replace with an API call (React Query, SWR, etc.) when the backend is ready.
 */
...
export const LOCATIONS = [
  ...new Set(MOCK_EMPLOYEES.map((e) => e.location)),
].sort()
